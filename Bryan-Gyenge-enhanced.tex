...
\]
\end{theorem}
Our proof of the above Theorem uses a trick exploiting the {\jim fact
that the stack quotient $\X =[\CC^{2}/\{\pm 1 \}]$ is birational to
the space $Y=\operatorname{Tot}(K_{\PP^{1}})$ (see section \ref{sec:
proof of formula for local series}).}
...
Pietromonaco, Bal\'azs Szendr\H{o}i, Shuai Wang, Alex Weekes, and {\jim the
referee} for helpful comments and/or technical help.
...
resolution of $\Sym^{m_{0}-(m_{1}-m_{0})^{2}} (\CC^{2}/\{\pm 1\})$.
