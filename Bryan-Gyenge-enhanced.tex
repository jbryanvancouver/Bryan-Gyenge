...
\})$. 
{\adam [I think the correct line of argument for the birational equivalence is as follows:]
When $n \geq 1$, both open substacks are symplectic resolutions of the
singular affine symplectic variety $\Sym^{n} (\CC^{2}/\{\pm 1
\})$ \cite[Sections~2 and 3]{nakajima2002geometric}. Hence, they intersect non-trivially, and we find that the equivalence induces a birational map
\[
\Hilb^{m_{0},m_{1}}(\X ) \dashrightarrow \Hilb^{n}(Y).
\]
}
...
%representations of the $A_{1}$ Nakajima quiver variety of the same dimension with possibly different dimension vectors. 
...
representations of the $A_{1}$ Nakajima quiver variety of the same dimension but using different stability conditions. Note that our $n$ coincides with the length $v_0-v^TCv/2$ of deHority.
}
