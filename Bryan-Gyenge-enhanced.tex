...
{\adam It is known that both $\Hilb^{m_{0},m_{1}}(\X )$ and $\Hilb^{n}(Y)$ can be realised as moduli spaces of quiver
	representations of the $A_{1}$ Nakajima quiver variety with possibly different dimension vectors and stability conditions (see \cite[Corollary 1.3]{bellamy2020birational}, \cite[Proposition 5.2]{craw2021quot}, \cite[page 2]{Kuznetsov}.)
...
%detail in \cite{Kuznetsov}, specifically the identification of $\Hilb
%(\X )$ and $\Hilb (Y)$ with Nakajima quiver varieties for specific
%stability conditions is given in \cite{Kuznetsov} at the bottom of
%page 2.
%{\adam [I think the correct line of argument for the deformation equivalence is as follows:]
%Both sides of the above birational equivalence are smooth, holomorphic
%symplectic varieties, and as we already mentioned they are both symplectic resolutions of the
%singular affine symplectic variety $\Sym^{n} (\CC^{2}/\{\pm 1
%\})$. 
%By \cite[Proposition 4.8]{dehority2020affinizations}, there is a birational equivalence
%\[\Hilb^{m_{0},m_{1}}(\X ) \dashrightarrow \Hilb^{n,n}(\X ),\]
%and therefore both Hilbert schemes can be realised as moduli spaces of quiver
%representations of the $A_{1}$ Nakajima quiver variety having the same
%dimension vector but using different stability conditions. Note that our $n$ coincides with the length $v_0-v^TCv/2$ of deHority.
%}
%{\adam [Another line of proof:]
%By CITE(Bellamy-Craw, Corollary 1.3) both Hilbert schemes can be realised as moduli spaces of quiver
%representations of the $A_{1}$ Nakajima quiver variety having the same
%dimension vector but using different stability conditions. 
%
...
\]
{\adam As $H$ acts symplectically on both sides, the hyperk\"ahler reduction providing the deformation equivalence in the proof of
...
%by \cite[Cor~4.2]{Nakajima1994Duke} are deformation equivalent. 
This
