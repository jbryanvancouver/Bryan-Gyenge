...
significance: they can be interpreted as a virtual counts of
$G$-invariant rational curves in a complete linear series of dimension
$n$ on $X$. This generalizes the famous Yau-Zaslow formula in the case
where $G$ is the trivial group. The precise nature between the virtual
count and the actual count is expected to be subtle for the case of
general $G$. This has been recently explored in
...
We appreviate the data $\left\{m_{j}(i) \right\}$ by the symbol
...
\]
where $\beta =ch(\FM (\alpha ))$. The Mukai equivalence induces the
