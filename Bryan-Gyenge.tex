...
$Z_{X,G}(q)$ also has an interpretation in enumerative geometry
generalizing: its coefficients count $G$-invariant rational curves on
...
As in the introduction, let $a = e(X/G)-r=e\left((X/G)^{o} \right)$. Then by G\"ottsche's formula \cite{gottsche1990betti},
\begin{align*}
...
proof of Theorem~\ref{thm: eta product formula for Z}. \qed 
