...
%\begin{table}[ht]
%\centering
The following table provides the list of modular forms, expressed as
eta products,  attached to the 82 possible symplectic
actions on a $K3$ surface. We follow the numbering in Xiao's list
\cite{Xiao}. 
